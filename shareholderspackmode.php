...
<head>
  <meta charset="UTF-8">
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Fircedar- Investment Plan</title>
    <meta name="description" content="Fircedar Company is at your service with its user-friendly features, secure infrastructure, and applications that make a difference. A firm for profitable investment solution, your financial stability, and freedom is our priority, join us to make your financial dreams come true">
    <meta name="keywords" content="Fircedar Company,Most Trusted Cryptocurrency Platform, wisetechglobal.com">
    ...
    <meta name="apple-mobile-web-app-title" content="Fircedar - Investment Plan">
    
    <meta itemprop="name" content="Fircedar - Investment Plan">
    <meta itemprop="description" content="">
    <meta itemprop="image" content="assets/images/seo/616fc12563d871634713893.png">
    
    <meta property="og:type" content="website">
    <meta property="og:title" content="Fircedar Company">
    <meta property="og:description" content="Fircedar Company">
    <meta property="og:image" content="assets/images/seo/616fc12563d871634713893.png"/>
    <meta property="og:image:type" content="image/png" />
        <meta property="og:image:width" content="600" />
    <meta property="og:image:height" content="315" />
    <meta property="og:url" content="user/plan">
      ...
      <div class="container">
        <nav class="navbar navbar-expand-xl p-0 align-items-center">
          ...
          <ul class="account-menu responsive-account-menu ml-3">
            <li class="icon">
              <a href="dashboard.html"><i class="las la-user"></i></a>
            </li>
          </ul> 
    ...
    <section class="page-title centred" style="background-image: url(assets/templates/bit_gold//assets/images/banner/pictures519.jpg);">
        ...
        <div class="auto-container">
            <div class="content-box clearfix"  style = "padding-top:30%;">
                ...
                <h1>Shareholder's Pack Investment Plan</h1>
...
<div class="card" style="width: 18rem; padding: 3cm; width:15cm;">
  ...
  <div class="card-body">
    ...
    <a href="shareholdersbtcpack.php" class="btn btn-primary">Continue</a>
  </div>
</div>
...
<div class="card" style="width: 18rem; padding: 3cm; width:15cm;">
  ...
  <div class="card-body">
    ...
    <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
    <a href="shareholdersethpack.php" class="btn btn-primary">Continue</a>
  </div>
</div>
...
<div class="card" style="width: 18rem; padding: 3cm; width:15cm;">
  ...
  <div class="card-body">
    ...
    <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
    <a href="shareholdersusdtpack.php" class="btn btn-primary">Continue</a>
  </div>
</div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-group ">
                            ...
                            <select class="form-control" name="wallet_type">
                                <option value="deposit_wallet">Deposit Wallet - $0</option>
...
<!-- <section class="pt-120 pb-120">
        ...
        <div class="row justify-content-center">
          <div class="col-lg-6">
            <div class="section-header text-center">
              <h2 class="section-title"><span class="font-weight-normal">Profit</span> <b style = "color:#000;">Calculator</b></h2>
                ...
                <div class="row">
                  <div class="col-lg-6">
                    ...
                    <select class="base--bg" id="changePlan">
                      <option value="9" >2022 Anniversary Pack</option>
                      <option value="8" >Beginner pack</option>
                      <option value="7" >Standard Pack</option>
                      <option value="6" >Gold Pack</option>
                      <option value="5" >Diamond Pack</option>
                    </select>
                  </div>

                  <div class="col-lg-6">
                    <label>Invest Amount</label>
                    <input style="color:#fff" type="text" name="#0" id="#0" placeholder="0.00" class="form-control base--bg invest-input" onkeyup="this.value = this.value.replace (/^\.|[^\d\.]/g, '')">
                  </div>
    ...
    <footer class="main-footer">
                            ...
                            <div class="footer-widget links-widget ml-70">
                                ...
                                <div class="widget-content">
                                    <ul class="list clearfix">
                                        ...
                                        <li><a href="withdraw.html">Withdraw Profit</a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
        ...
        <div class="footer-bottom">
            <div class="auto-container">
                <div class="copyright"><p>&copy; 2018 <a href="index.html">Fircedar</a> - Investment. All rights reserved.</p></div>
            </div>
        </div>
    </footer>
    <!-- main-footer end -->
