    ...
    <div class="row justify-content-center">
      <div class="col-lg-6 text-center">
        <div class="section-header">
          ...
          <p>To invest in Children's Pack you must have a minimum balance of $1000 in your Deposit wallet</p>
        </div>
      </div>
    </div>
<center>
    ...
    <form action="diamondbtcpack.inc.php" class = "container-md border border-primary mt-5 mb-5 pt-4 pb-4" method="POST">
