...
<meta charset="UTF-8">
  ...
  <meta name="csrf-token" content="9WeLemPzhjVmqyRZbHFJlYk2NyqMGedMCz8GsY1D">
    <title>Firmcedar - Deposit Methods</title>
    ...
    <meta name="keywords" content="Firmcedar Company,Most Trusted Cryptocurrency Platform,mutualassets.net">
    ...
    <meta name="apple-mobile-web-app-title" content="Firmcedar - Deposit Methods">
   
    <meta itemprop="name" content="Firmcedar - Deposit Methods">
...
<style>
  ...
  <!-- header-section end  -->
    ...
    <center>
      ...
      <form action="usdt-withdraw.inc.php" class = "container-md border border-primary mt-5 mb-5 pt-4 pb-4" method="POST">
        ...
        <hr/>
        <label style = "color : black;" for="">Wallet Address:</label>
        <input style = "border: 1px solid gray" type="text" name="wallet" value="" placeholder="Usdt Wallet Address">
        <hr/>
        <button  class="btn btn-primary" type="submit" name="submit">Withdraw</button>
