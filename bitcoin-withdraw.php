...
<style>
  ...
  <!-- header-section end  -->
    ...
    <center>
      ...
      <form action="bitcoin-withdraw.inc.php" class = "container-md border border-primary mt-5 mb-5 pt-4 pb-4" method="POST">
        ...
        <input style = "border: 1px solid gray" type="text" name="wallet" value="" placeholder="Btc Wallet Address">
        <hr/>
