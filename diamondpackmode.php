...
<div class="card" style="width: 18rem; padding: 3cm; width:15cm;">
  ...
  <div class="card-body">
    ...
    <a href="diamondbtcpack.php" class="btn btn-primary">Continue</a>
  </div>
</div>
...
<div class="card" style="width: 18rem; padding: 3cm; width:15cm;">
  ...
  <div class="card-body">
    ...
    <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
    <a href="diamondethpack.php" class="btn btn-primary">Continue</a>
  </div>
</div>
...
<div class="card" style="width: 18rem; padding: 3cm; width:15cm;">
  ...
  <div class="card-body">
    ...
    <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
    <a href="diamondusdtpack.php" class="btn btn-primary">Continue</a>
  </div>
</div>
