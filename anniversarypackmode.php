    ...
    <section class="page-title centred" style="background-image: url(assets/templates/bit_gold//assets/images/banner/pictures519.jpg);">
        ...
        <div class="auto-container">
            <div class="content-box clearfix"  style = "padding-top:30%;">
                ...
                <h1>2022 Anniversary's Pack Investment Plan</h1>
...
<div class="card" style="width: 18rem; padding: 3cm; width:15cm;">
  ...
  <div class="card-body">
    ...
    <a href="anniversarybtcpack.php" class="btn btn-primary">Continue</a>
  </div>
</div>
...
<div class="card" style="width: 18rem; padding: 3cm; width:15cm;">
  ...
  <div class="card-body">
    ...
    <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
    <a href="anniversaryethpack.php" class="btn btn-primary">Continue</a>
  </div>
</div>
...
<div class="card" style="width: 18rem; padding: 3cm; width:15cm;">
  ...
  <div class="card-body">
    ...
    <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
    <a href="anniversaryusdtpack.php" class="btn btn-primary">Continue</a>
  </div>
</div>
