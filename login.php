...
<head>
  ...
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
    ...
    <meta name="keywords" content="Firmcedar Company,Most Trusted Cryptocurrency Platform,Firmcedar">
    ...
    <meta name="apple-mobile-web-app-title" content="Firmcedar - Sign In">
    
    <meta itemprop="name" content="Firmcedar - Sign In">
...
<link href="https://fonts.googleapis.com/css?family=Arimo:400,400i,700,700i&amp;display=swap" rel="stylesheet">
  ...
  <div class="boxed_wrapper ltr">
                            ...
                            <div class="collapse navbar-collapse show clearfix" id="navbarSupportedContent">
                                <ul class="navigation clearfix">
                                    ...
                                    <li>
                                        ...
                                        </div><script src="../translate.yandex.net/website-widget/v1/widget80d6.js?widgetId=ytWidget&amp;pageLang=en&amp;widgetTheme=light&amp;autoMode=false" type="text/javascript"></script>
    ...
    <div class="account-section bg_img" data-background="assets/images/frontend/login/5fce3a113b6d91607350801.jpg" style = "margin-top: 40px;">
      <div class="container">
          ...
          <div class="col-xl-5 col-lg-7">
            <div class="account-card">
              <div class="account-card__header bg_img overlay--one" data-background="assets/images/frontend/login/5fce3a1188a861607350801.jpg">
                <h2 class="section-title"style = "padding-top:100px"><span class="base--color">Welcome To Firmcedar Company</span></h2>
    ...
    <!-- main-footer -->
    <footer class="main-footer" style = "width: 100%; margin-top: 50px;">
                ...
                <div class="sidebar-info-contents">
                    <div class="content-inner">
                        <div class="upper-box">
                            ...
                            <div class="text">
                                <p>Firmcedar Investment: Experienced. Specialized. Professional..</p>
                            </div>
                        </div>
